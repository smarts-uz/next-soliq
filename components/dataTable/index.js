...
const datTable = (props) => {
  ...
  return (
    <div className="flex flex-col my-4 text-center w-full overflow-hidden">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg- divide-y divide-white">
                {props?.users?.map((user) => {
                  return (
                    <tr className="bg-blue-100 hover:bg-white" key={user.inn}>
                      ...
                      <td className="pr-4 py-4  whitespace-nowrap text-left text-sm font-medium">
                        ...
                        <button
                          ...
                          onClick={async () => {
                            await axios
                              .post("/api/Datas/delete", { id: user.id })
                              .then((data) => {
                                console.log(data);
                        ...
                        >
                          <img
                            className="w-12"
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT58doyRh34c2U2fhUT-oeTSq7Pf30VioAVow&usqp=CAU"
                          ></img>
                        </button>
                      </td>
                    </tr>
      ...
      >
        <BasicWithHTML data={{ ...oneUser }} {...props} />
      </Modal>
    </div>
  );
};
