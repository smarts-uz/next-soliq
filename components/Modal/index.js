                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex justify-between  space-x-20 items-center bg-blue-50 p-12 font-sans text-2xl">
                            ...
                            <div className="flex flex-col">
                                <p className="border-b-4 border-blue-900 bg-pink-500 text-sm w-64 rounded-t-xl p-4">Passpord: {props.data?.series_passport} {props.data?.number_passport}</p>
                                <p className="bg-green-300  p-2 text-sm py-4">place: {props.data?.org_passport}</p>
                                <p className="bg-green-300 border-t-4 border-blue-900 rounded-b-xl p-2 text-sm py-4">date: {props.data?.issued_passport}</p>
                            </div>
                        </div>
                    </div>
