      ...
      <div className="flex flex-col justify-center md:px-32 h-screen">
        <div className="flex justify-end">
          <button
            ...
            className="bg-green-600 px-5 rounded text-white text-lg uppercase font-bold border-2 border-gray-700 py-1 hover:bg-white hover:text-black"
          >
            Create
          </button>
        </div>
        <Table
          ...
          underCategories={props.underCategories}
          themes={props.themes}
          types={props.types}
          users={props.datas ? props.datas : []}
        />
      </div>
    </>
  );
